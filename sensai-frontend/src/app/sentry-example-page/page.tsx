    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://hva-di.sentry.io/issues/?project=4510531724181504">Issues Page</a>.
